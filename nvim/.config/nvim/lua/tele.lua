...
vim.api.nvim_set_keymap('n', 'fg', '<cmd>lua require(\'telescope.builtin\').live_grep{vimgrep_arguments = { \'rg\', \'--color=never\', \'--no-heading\', \'--with-filename\', \'--line-number\', \'--column\', \'--smart-case\', \'-u\', \'--hidden\'}}<cr>', opts)
